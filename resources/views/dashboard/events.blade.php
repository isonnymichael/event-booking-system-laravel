                    ...
                    @foreach ($events as $event)
                        <tr>
                            ...
                            <td class="text-center">
                                @if (Auth::user()->role == "admin")
                                    <a class="btn btn-info p-1 mr-1" href="/event/{{$event->id}}"><i class="fas fa-eye"></i></a>
                                    <button onclick="editEvent({{json_encode($event)}})" class="btn btn-warning p-1"><i class="fas fa-edit"></i></button>
                                    <button onclick="deleteEvent({{$event->id}},'{{$event->title}}')" class="btn btn-danger p-1 ml-1"><i class="fas fa-trash"></i></button>
                                @elseif (Auth::user()->id == $event->id_user)
                                    <a class="btn btn-info p-1 mr-1" href="/event/{{$event->id}}"><i class="fas fa-eye"></i></a>
                                    <button onclick="editEvent({{json_encode($event)}})" class="btn btn-warning p-1"><i class="fas fa-edit"></i></button>
                                    <button onclick="deleteEvent({{$event->id}},'{{$event->title}}')" class="btn btn-danger p-1 ml-1"><i class="fas fa-trash"></i></button>
                                @else
                    ...
                    <form id="form-edit-event" method="POST" action="/event/edit">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <input name="slots_available" min="1" type="number" class="form-control" id="edit-slots" required>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form id="form-add-event" method="POST" action="/event/add">
                        ...
                        <div class="row">
                            <div class="col-6 form-group">
                                ...
                                <input name="date" min="{{\Carbon\Carbon::now()->addDays(2)->format('Y-m-d')}}" type="date" class="form-control" id="add-date" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <input name="slots_available" min="1" type="number" class="form-control" id="add-slots" required>
                            </div>
                        </div>
                    </form>
                </div>
